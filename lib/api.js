...
export const api = {
  ...
  // キャンセル待ちの自分の登録一覧（マイ予約と対になる画面、Meta CEO視点レビュー・審判団ラウンド46で新設）
  getMyWaitlist: (lineUserId, phone, name, idToken) =>
    post('myWaitlist', { lineUserId, phone, name, idToken }),
  ...
  cancelMyWaitlistEntry: (data) => post('cancelMyWaitlistEntry', { data }),
