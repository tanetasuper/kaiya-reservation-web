...
const EN_DICT = {
  ...
  '選択した来店日を1回目として、以降を自動で申し込みます。満席等で確定できない回があった場合は、その回だけ個別にご連絡します。':
    'Your selected date will be the 1st occurrence; the rest will be booked automatically. If any occurrence can\'t be confirmed (e.g. fully booked), we\'ll contact you about that occurrence individually.',
